  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          object:: "okta_user",
          type:: "data",
          attributes:: ["admin_roles", "city", "compound_search_operator", "cost_center", "country_code", "custom_profile_attributes", "delay_read_seconds", "department", "display_name", "division", "email", "employee_number", "first_name", "group_memberships", "honorific_prefix", "honorific_suffix", "id", "last_name", "locale", "login", "manager", "manager_id", "middle_name", "mobile_phone", "nick_name", "organization", "postal_address", "preferred_language", "primary_phone", "profile_url", "realm_id", "roles", "second_email", "skip_groups", "skip_roles", "state", "status", "street_address", "timezone", "title", "user_id", "user_type", "zip_code"],
        },
      },
    }
  ),
