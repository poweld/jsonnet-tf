{
  local block = self,
  new(terraformName, agentArns, password, serverHostname, subdirectory, user):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_datasync_location_smb",
          type:: "resource",
          attributes:: ["agent_arns", "arn", "domain", "id", "password", "region", "server_hostname", "subdirectory", "tags", "tags_all", "uri", "user"],
        },
      },
    }
