{
  local block = self,
  new(terraformName, name, profileId, resourceId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_route53profiles_association",
          type:: "resource",
          attributes:: ["arn", "id", "name", "owner_id", "profile_id", "region", "resource_id", "status", "status_message", "tags", "tags_all"],
        },
      },
    }
    + block.withName(name)
