{
  local block = self,
  new(terraformName, snsTopic):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_db_event_subscription",
          type:: "resource",
          attributes:: ["arn", "customer_aws_id", "enabled", "event_categories", "id", "name", "name_prefix", "region", "sns_topic", "source_ids", "source_type", "tags", "tags_all"],
        },
      },
    }
