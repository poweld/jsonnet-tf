{
  ...
  new(terraformName, transitGatewayAttachmentId, transitGatewayRouteTableId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_ec2_transit_gateway_route_table_association",
          type:: "resource",
          attributes:: ["id", "region", "replace_existing_association", "resource_id", "resource_type", "transit_gateway_attachment_id", "transit_gateway_route_table_id"],
        },
      },
    }
  ...
  withReplaceExistingAssociation(value):: (
    local converted = value;
