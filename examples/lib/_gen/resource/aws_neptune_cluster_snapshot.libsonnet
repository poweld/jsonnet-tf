  ...
  new(terraformName, dbClusterIdentifier, dbClusterSnapshotIdentifier):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_neptune_cluster_snapshot",
          type:: "resource",
          attributes:: ["allocated_storage", "availability_zones", "db_cluster_identifier", "db_cluster_snapshot_arn", "db_cluster_snapshot_identifier", "engine", "engine_version", "id", "kms_key_id", "license_model", "port", "region", "snapshot_type", "source_db_cluster_snapshot_arn", "status", "storage_encrypted", "vpc_id"],
        },
      },
    }
