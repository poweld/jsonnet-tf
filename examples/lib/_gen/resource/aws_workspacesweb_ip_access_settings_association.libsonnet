{
  local block = self,
  new(terraformName, ipAccessSettingsArn, portalArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_workspacesweb_ip_access_settings_association",
          type:: "resource",
          attributes:: ["ip_access_settings_arn", "portal_arn", "region"],
        },
      },
    }
    + block.withIpAccessSettingsArn(ipAccessSettingsArn)
    + block.withPortalArn(portalArn)
  ),
  withIpAccessSettingsArn(value):: (
