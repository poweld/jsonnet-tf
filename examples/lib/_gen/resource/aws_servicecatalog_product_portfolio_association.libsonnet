{
  local block = self,
  new(terraformName, portfolioId, productId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_servicecatalog_product_portfolio_association",
          type:: "resource",
          attributes:: ["accept_language", "id", "portfolio_id", "product_id", "region", "source_portfolio_id"],
        },
      },
    }
