{
  local block = self,
  new(terraformName, internetGatewayExclusionMode):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_vpc_block_public_access_exclusion",
          type:: "resource",
          attributes:: ["id", "internet_gateway_exclusion_mode", "region", "resource_arn", "subnet_id", "tags", "tags_all", "vpc_id"],
        },
      },
    }
    + block.withInternetGatewayExclusionMode(internetGatewayExclusionMode)
  ),
