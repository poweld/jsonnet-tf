  ...
  new(terraformName, httpMethod, resourceId, restApiId, statusCode):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_api_gateway_integration_response",
          type:: "resource",
          attributes:: ["content_handling", "http_method", "id", "region", "resource_id", "response_parameters", "response_templates", "rest_api_id", "selection_pattern", "status_code"],
        },
      },
    }
