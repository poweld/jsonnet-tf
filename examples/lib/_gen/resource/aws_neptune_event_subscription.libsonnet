{
  local block = self,
  new(terraformName, snsTopicArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_neptune_event_subscription",
          type:: "resource",
          attributes:: ["arn", "customer_aws_id", "enabled", "event_categories", "id", "name", "name_prefix", "region", "sns_topic_arn", "source_ids", "source_type", "tags", "tags_all"],
        },
      },
    }
