{
  local block = self,
  new(terraformName, addressFamily, bgpAsn, connectionId, dxGatewayId, name, vlan):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_dx_transit_virtual_interface",
          type:: "resource",
          attributes:: ["address_family", "amazon_address", "amazon_side_asn", "arn", "aws_device", "bgp_asn", "bgp_auth_key", "connection_id", "customer_address", "dx_gateway_id", "id", "jumbo_frame_capable", "mtu", "name", "region", "sitelink_enabled", "tags", "tags_all", "vlan"],
        },
      },
    }
