  ...
  new(terraformName, instanceId, name):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_connect_security_profile",
          type:: "resource",
          attributes:: ["arn", "description", "id", "instance_id", "name", "organization_resource_id", "permissions", "region", "security_profile_id", "tags", "tags_all"],
        },
      },
    }
