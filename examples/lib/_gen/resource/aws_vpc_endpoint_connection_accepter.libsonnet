{
  local block = self,
  new(terraformName, vpcEndpointId, vpcEndpointServiceId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_vpc_endpoint_connection_accepter",
          type:: "resource",
          attributes:: ["id", "region", "vpc_endpoint_id", "vpc_endpoint_service_id", "vpc_endpoint_state"],
        },
      },
    }
