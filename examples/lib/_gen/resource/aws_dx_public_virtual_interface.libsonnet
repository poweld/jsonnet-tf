{
  local block = self,
  new(terraformName, addressFamily, bgpAsn, connectionId, name, routeFilterPrefixes, vlan):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_dx_public_virtual_interface",
          type:: "resource",
          attributes:: ["address_family", "amazon_address", "amazon_side_asn", "arn", "aws_device", "bgp_asn", "bgp_auth_key", "connection_id", "customer_address", "id", "name", "region", "route_filter_prefixes", "tags", "tags_all", "vlan"],
        },
      },
    }
