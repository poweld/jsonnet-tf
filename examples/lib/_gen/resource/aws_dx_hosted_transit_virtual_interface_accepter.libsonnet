{
  local block = self,
  new(terraformName, dxGatewayId, virtualInterfaceId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_dx_hosted_transit_virtual_interface_accepter",
          type:: "resource",
          attributes:: ["arn", "dx_gateway_id", "id", "region", "tags", "tags_all", "virtual_interface_id"],
        },
      },
    }
