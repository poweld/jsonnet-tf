{
  local block = self,
  new(terraformName, guardrailArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_bedrock_guardrail_version",
          type:: "resource",
          attributes:: ["description", "guardrail_arn", "region", "skip_destroy", "version"],
        },
      },
    }
    + block.withGuardrailArn(guardrailArn)
  ),
