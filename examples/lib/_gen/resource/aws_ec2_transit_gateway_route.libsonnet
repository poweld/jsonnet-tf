{
  local block = self,
  new(terraformName, destinationCidrBlock, transitGatewayRouteTableId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_ec2_transit_gateway_route",
          type:: "resource",
          attributes:: ["blackhole", "destination_cidr_block", "id", "region", "transit_gateway_attachment_id", "transit_gateway_route_table_id"],
        },
      },
    }
