{
  local block = self,
  new(terraformName, awsAccountId, networkInterfaceId, permission):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_network_interface_permission",
          type:: "resource",
          attributes:: ["aws_account_id", "network_interface_id", "network_interface_permission_id", "permission", "region"],
        },
      },
    }
    + block.withAwsAccountId(awsAccountId)
