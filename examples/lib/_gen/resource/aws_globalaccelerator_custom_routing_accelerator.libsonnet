  ...
  new(terraformName, name):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_globalaccelerator_custom_routing_accelerator",
          type:: "resource",
          attributes:: ["arn", "dns_name", "enabled", "hosted_zone_id", "id", "ip_address_type", "ip_addresses", "ip_sets", "name", "tags", "tags_all"],
        },
      },
    }
    + block.withName(name)
