{
  local block = self,
  new(terraformName, portalArn, userSettingsArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_workspacesweb_user_settings_association",
          type:: "resource",
          attributes:: ["portal_arn", "region", "user_settings_arn"],
        },
      },
    }
    + block.withPortalArn(portalArn)
    + block.withUserSettingsArn(userSettingsArn)
  ),
  withPortalArn(value):: (
