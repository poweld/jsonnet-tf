{
  local block = self,
  new(terraformName, name, providerName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_servicecatalog_portfolio",
          type:: "resource",
          attributes:: ["arn", "created_time", "description", "id", "name", "provider_name", "region", "tags", "tags_all"],
        },
      },
    }
    + block.withName(name)
