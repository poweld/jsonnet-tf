  ...
  new(terraformName, integrationName, sourceArn, targetArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_redshift_integration",
          type:: "resource",
          attributes:: ["additional_encryption_context", "arn", "description", "integration_name", "kms_key_id", "region", "source_arn", "tags", "tags_all", "target_arn"],
        },
      },
    }
