  ...
  new(terraformName, primaryKeyArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_kms_replica_key",
          type:: "resource",
          attributes:: ["arn", "bypass_policy_lockout_safety_check", "deletion_window_in_days", "description", "enabled", "id", "key_id", "key_rotation_enabled", "key_spec", "key_usage", "policy", "primary_key_arn", "region", "tags", "tags_all"],
        },
      },
    }
