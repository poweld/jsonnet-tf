  ...
  new(terraformName, globalClusterIdentifier):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_neptune_global_cluster",
          type:: "resource",
          attributes:: ["arn", "deletion_protection", "engine", "engine_version", "global_cluster_identifier", "global_cluster_members", "global_cluster_resource_id", "id", "region", "source_db_cluster_identifier", "status", "storage_encrypted"],
        },
      },
    }
