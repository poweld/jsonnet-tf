{
  ...
  new(terraformName, stackSetName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_cloudformation_stack_set_instance",
          type:: "resource",
          attributes:: ["account_id", "call_as", "id", "organizational_unit_id", "parameter_overrides", "region", "retain_stack", "stack_id", "stack_instance_summaries", "stack_set_instance_region", "stack_set_name"],
        },
      },
    }
  ...
  withStackSetInstanceRegion(value):: (
    local converted = value;
