{
  local block = self,
  new(terraformName, domainName, serviceArn):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_apprunner_custom_domain_association",
          type:: "resource",
          attributes:: ["certificate_validation_records", "dns_target", "domain_name", "enable_www_subdomain", "id", "region", "service_arn", "status"],
        },
      },
    }
