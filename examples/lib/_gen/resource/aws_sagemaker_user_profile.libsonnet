{
  local block = self,
  new(terraformName, domainId, userProfileName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_sagemaker_user_profile",
          type:: "resource",
          attributes:: ["arn", "domain_id", "home_efs_file_system_uid", "id", "region", "single_sign_on_user_identifier", "single_sign_on_user_value", "tags", "tags_all", "user_profile_name"],
        },
      },
    }
    + block.withDomainId(domainId)
    + block.withUserProfileName(userProfileName)
  ),
  withDomainId(value):: (
