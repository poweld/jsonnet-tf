{
  local block = self,
  new(terraformName, applicationName, snapshotName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_kinesisanalyticsv2_application_snapshot",
          type:: "resource",
          attributes:: ["application_name", "application_version_id", "id", "region", "snapshot_creation_timestamp", "snapshot_name"],
        },
      },
    }
    + block.withApplicationName(applicationName)
