  ...
  new(terraformName, globalClusterIdentifier):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_docdb_global_cluster",
          type:: "resource",
          attributes:: ["arn", "database_name", "deletion_protection", "engine", "engine_version", "global_cluster_identifier", "global_cluster_members", "global_cluster_resource_id", "id", "region", "source_db_cluster_identifier", "status", "storage_encrypted"],
        },
      },
    }
