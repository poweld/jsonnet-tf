{
  local block = self,
  new(terraformName, transitGatewayId, transitGatewayRouteTableId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_ec2_transit_gateway_default_route_table_association",
          type:: "resource",
          attributes:: ["id", "original_default_route_table_id", "region", "transit_gateway_id", "transit_gateway_route_table_id"],
        },
      },
    }
