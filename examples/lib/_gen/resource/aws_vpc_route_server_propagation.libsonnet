{
  local block = self,
  new(terraformName, routeServerId, routeTableId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_vpc_route_server_propagation",
          type:: "resource",
          attributes:: ["region", "route_server_id", "route_table_id"],
        },
      },
    }
    + block.withRouteServerId(routeServerId)
