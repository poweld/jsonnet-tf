{
  ...
  new(terraformName, name):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_cloudfront_cache_policy",
          type:: "resource",
          attributes:: ["arn", "comment", "default_ttl", "etag", "id", "max_ttl", "min_ttl", "name"],
        },
      },
    }
    + block.withName(name)
  ...
  parameters_in_cache_key_and_forwarded_to_origin:: {
    ...
    withEnableAcceptEncodingBrotli(value):: (
      local converted = value;
    ...
    withEnableAcceptEncodingGzip(value):: (
      local converted = value;
