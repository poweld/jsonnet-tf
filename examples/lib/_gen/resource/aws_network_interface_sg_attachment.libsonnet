{
  local block = self,
  new(terraformName, networkInterfaceId, securityGroupId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_network_interface_sg_attachment",
          type:: "resource",
          attributes:: ["id", "network_interface_id", "region", "security_group_id"],
        },
      },
    }
