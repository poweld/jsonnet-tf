{
  local block = self,
  new(terraformName, serviceIdentifier, serviceNetworkIdentifier):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_vpclattice_service_network_service_association",
          type:: "resource",
          attributes:: ["arn", "created_by", "custom_domain_name", "dns_entry", "id", "region", "service_identifier", "service_network_identifier", "status", "tags", "tags_all"],
        },
      },
    }
