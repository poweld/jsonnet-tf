{
  local block = self,
  new(terraformName, infrastructureConfigurationArn, name):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_imagebuilder_image_pipeline",
          type:: "resource",
          attributes:: ["arn", "container_recipe_arn", "date_created", "date_last_run", "date_next_run", "date_updated", "description", "distribution_configuration_arn", "enhanced_image_metadata_enabled", "execution_role", "id", "image_recipe_arn", "infrastructure_configuration_arn", "name", "platform", "region", "status", "tags", "tags_all"],
        },
      },
    }
