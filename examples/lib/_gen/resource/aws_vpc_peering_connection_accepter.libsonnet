{
  local block = self,
  new(terraformName, vpcPeeringConnectionId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_vpc_peering_connection_accepter",
          type:: "resource",
          attributes:: ["accept_status", "auto_accept", "id", "peer_owner_id", "peer_region", "peer_vpc_id", "region", "tags", "tags_all", "vpc_id", "vpc_peering_connection_id"],
        },
      },
    }
    + block.withVpcPeeringConnectionId(vpcPeeringConnectionId)
  ),
