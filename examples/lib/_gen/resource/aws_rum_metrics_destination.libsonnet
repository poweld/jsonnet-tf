{
  local block = self,
  new(terraformName, appMonitorName, destination):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_rum_metrics_destination",
          type:: "resource",
          attributes:: ["app_monitor_name", "destination", "destination_arn", "iam_role_arn", "id", "region"],
        },
      },
    }
    + block.withAppMonitorName(appMonitorName)
