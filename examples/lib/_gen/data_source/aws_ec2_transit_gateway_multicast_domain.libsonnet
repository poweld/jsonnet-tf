  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["arn", "associations", "auto_accept_shared_associations", "id", "igmpv2_support", "members", "owner_id", "region", "sources", "state", "static_sources_support", "tags", "transit_gateway_attachment_id", "transit_gateway_id", "transit_gateway_multicast_domain_id"],
        },
      },
    }
  ),
