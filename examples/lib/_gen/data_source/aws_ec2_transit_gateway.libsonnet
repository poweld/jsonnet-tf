  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["amazon_side_asn", "arn", "association_default_route_table_id", "auto_accept_shared_attachments", "default_route_table_association", "default_route_table_propagation", "description", "dns_support", "id", "multicast_support", "owner_id", "propagation_default_route_table_id", "region", "security_group_referencing_support", "tags", "transit_gateway_cidr_blocks", "vpn_ecmp_support"],
        },
      },
    }
  ),
