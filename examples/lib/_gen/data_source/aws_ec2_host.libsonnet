  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          object:: "aws_ec2_host",
          type:: "data",
          attributes:: ["arn", "asset_id", "auto_placement", "availability_zone", "cores", "host_id", "host_recovery", "id", "instance_family", "instance_type", "outpost_arn", "owner_id", "region", "sockets", "tags", "total_vcpus"],
        },
      },
    }
  ),
