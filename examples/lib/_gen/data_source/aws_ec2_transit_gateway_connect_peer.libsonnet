  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["arn", "bgp_asn", "bgp_peer_address", "bgp_transit_gateway_addresses", "id", "inside_cidr_blocks", "peer_address", "region", "tags", "transit_gateway_address", "transit_gateway_attachment_id", "transit_gateway_connect_peer_id"],
        },
      },
    }
  ),
