  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["arn", "dhcp_options_id", "domain_name", "domain_name_servers", "id", "ipv6_address_preferred_lease_time", "netbios_name_servers", "netbios_node_type", "ntp_servers", "owner_id", "region", "tags"],
        },
      },
    }
  ),
