  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["appliance_mode_support", "arn", "dns_support", "id", "ipv6_support", "region", "security_group_referencing_support", "subnet_ids", "tags", "transit_gateway_id", "vpc_id", "vpc_owner_id"],
        },
      },
    }
  ),
