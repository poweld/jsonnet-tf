  ...
  new(terraformName, owners):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          object:: "aws_ami_ids",
          type:: "data",
          attributes:: ["executable_users", "id", "ids", "include_deprecated", "name_regex", "owners", "region", "sort_ascending"],
        },
      },
    }
    + block.withOwners(owners)
  ),
