  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_ec2_transit_gateway_attachment",
          type:: "data",
          attributes:: ["arn", "association_state", "association_transit_gateway_route_table_id", "id", "region", "resource_id", "resource_owner_id", "resource_type", "state", "tags", "transit_gateway_attachment_id", "transit_gateway_id", "transit_gateway_owner_id"],
        },
      },
    }
  ),
