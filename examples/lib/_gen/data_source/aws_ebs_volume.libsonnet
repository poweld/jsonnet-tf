  ...
  new(terraformName):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["arn", "availability_zone", "create_time", "encrypted", "id", "iops", "kms_key_id", "most_recent", "multi_attach_enabled", "outpost_arn", "region", "size", "snapshot_id", "tags", "throughput", "volume_id", "volume_initialization_rate", "volume_type"],
        },
      },
    }
  ),
