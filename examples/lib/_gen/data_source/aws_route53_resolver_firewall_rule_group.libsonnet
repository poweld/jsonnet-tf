  ...
  new(terraformName, firewallRuleGroupId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_route53_resolver_firewall_rule_group",
          type:: "data",
          attributes:: ["arn", "creation_time", "creator_request_id", "firewall_rule_group_id", "id", "modification_time", "name", "owner_id", "region", "rule_count", "share_status", "status", "status_message"],
        },
      },
    }
