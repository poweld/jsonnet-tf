{
  local block = self,
  new(terraformName, transitGatewayRouteTableId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          name:: terraformName,
          object:: "aws_ec2_transit_gateway_route_table_propagations",
          type:: "data",
          attributes:: ["id", "ids", "region", "transit_gateway_route_table_id"],
        },
      },
    }
