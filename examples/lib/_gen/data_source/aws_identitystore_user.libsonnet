  ...
  new(terraformName, identityStoreId):: (
    {
      jsonnetTfMetadata:: {
        terraform:: {
          ...
          type:: "data",
          attributes:: ["addresses", "display_name", "emails", "external_ids", "id", "identity_store_id", "locale", "name", "nickname", "phone_numbers", "preferred_language", "profile_url", "region", "timezone", "title", "user_id", "user_name", "user_type"],
        },
      },
    }
