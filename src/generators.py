...
class JsonnetFileGenerator:
    ...
    def generate_provider(self, provider: str, provider_schema: ProviderSchema, 
                         provider_source: str, provider_version: str) -> None:
        """
        ...
        # Write provider file
        self._write_jsonnet_file(f"{provider_dir}/provider.libsonnet", 
                               jsonnet_provider_schema["provider"])
    ...
    def _format_jsonnet_files(self, directory: str) -> None:
        ...
        try:
            ...
            ps = subprocess.Popen(
                ["find", f"{directory}/", "-name", "*.*sonnet", "-print0"],
